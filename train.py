...
parser.add_argument("--memory_size", default=16, type=int, help=
                      "The number of memory slots.")
parser.add_argument("--word_size", default=16, type=int, help=
                      "The width of each memory slot.")
parser.add_argument("--num_write_heads", default=1, type=int, help=
                      "Number of memory write heads.")
parser.add_argument("--num_read_heads", default=4, type=int, help=
                      "Number of memory read heads.")
parser.add_argument("--clip_value", default=20, type=int, help=
                      "Maximum absolute value of controller and dnc outputs.")

# Optimizer parameters.
parser.add_argument("--max_grad_norm", default=50, type=float, help=
                      "Gradient clipping norm limit.")
parser.add_argument("--learning_rate", default=1e-4, type=float, help=
                      "Optimizer learning rate.")
parser.add_argument("--optimizer_epsilon", default=1e-10, type=float, help=
...
parser.add_argument("--log_dir", default="./logs/dnc/", type=str, help=
                      "Logging directory.")
parser.add_argument("--report_interval", default=100, type=int, help=
                      "Epochs between reports (samples, valid loss).")
parser.add_argument("--checkpoint_dir", default="./checkpoints/repeat_copy", type=str, help=
                      "Checkpointing directory.")
parser.add_argument("--checkpoint_interval", default=2000, type=int, help=
